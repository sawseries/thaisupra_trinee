...
<div class="container">
    ...
    <div class="row" style="border: 1px solid #5EB11A;margin-top: 20px;margin-bottom:50px;border-radius: 10px;padding-bottom: 100px;">
        ...
        <div class="child">
            <div class="page_header">
                <table class="table" border="0">
                    <tr>
                        <td>
                            <span class="text_blue"><b>ส่วนที่ 3 การวิเคราะห์ประเด็นท้าทายในการพัฒนาผลลัพธ์การเรียนรู้ของผู้เรียน</b></span>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <center>
            <a class="btn_page" href="{{ url('pa_4') }}">ไปยังขั้นตอนต่อไป</a>
        </center>
