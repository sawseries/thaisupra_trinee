...
<div class="container">
    ...
    <div class="row" style="border: 1px solid #5EB11A;margin-top: 20px;margin-bottom:50px;border-radius: 10px;padding-bottom: 100px;">
        ...
        <div class="child">
            ...
            <table style="width: 100%;" border="0">
                <tr style="height: 70px;">
                    ...
                    <td style="text-align:right;width: 50%;">
                        <a class="btn_page" ><span class="glyphicon glyphicon-plus"></span> เพิ่ม</a>
                    </td>
                </tr>
            </table>  
         ...
         <div class="child">
            <div class="page_header">
                ...
                <tr style="height: 70px;">
                    ...
                    <td style="text-align:right;width: 50%;">
                        <a class="btn_page" ><span class="glyphicon glyphicon-plus"></span> เพิ่มสื่อการเรียนรู้ / นวัตกรรม</a>
                    </td>
                </tr>
            </table>  
            </div>
        ...
        <center>
            <a href="{{ url('pa_2_2') }}" class="btn_page"> ไปยังขั้นตอนต่อไป </a>
        </center>
